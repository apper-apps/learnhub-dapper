  ...
  return (
    <AuthContext.Provider value={authMethods}>
      <Routes>
        ...
        <Route path="/master" element={<Layout><MasterPage /></Layout>} />
        <Route path="/insights" element={<Layout><InsightsPage /></Layout>} />
        <Route path="/testimonials" element={<Layout><TestimonialsPage /></Layout>} />
        <Route path="/video/:id" element={<Layout><VideoPlayerPage /></Layout>} />
        <Route path="/article/:id" element={<Layout><ArticleViewerPage /></Layout>} />
        <Route path="/upload-video/:category" element={<Layout><VideoUploadPage /></Layout>} />
        <Route path="/curriculum-upload/:category" element={<Layout><VideoUploadPage /></Layout>} />
        <Route path="/edit-video/:id" element={<Layout><VideoEditPage /></Layout>} />
        <Route path="/upload-article" element={<Layout><ArticleUploadPage /></Layout>} />
        <Route path="/edit-article/:id" element={<Layout><ArticleEditPage /></Layout>} />
      </Routes>
      <ToastContainer
        position="top-right"
        autoClose={3000}
